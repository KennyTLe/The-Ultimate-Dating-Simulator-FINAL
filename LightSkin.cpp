...
LightSkin::LightSkin(string _name) : Character(120, 5, 50, 40){
  Character::setName(_name);
}

// Prints User Stats
void LightSkin::PrintAll(){
  system("clear");
  cout << endl << "Name: " << Character::getName() << endl;
  cout << endl << "Character Type: LightSkin" << endl;
  cout << "Health: " << Character::getHealth() << endl;
  cout << "Smooth Compliment: " << Character::getMove1() << " dmg" << endl;
  cout << "Handheld Mirror Check Up: " << Character::getMove2() << " hp healed" << endl;
  cout << "Light Skin Stare (3 round charge up): " << Character::getMove3() << " dmg" << endl;
}

// Initiates The First Date
void LightSkin::FirstDate(){
  system("clear");
  ...
  cin >> reply;
  cout << endl << "  You: \"Thanks...\"" << endl;
  cin >> reply;
  cout << endl << "  You: \"BUT YOUR NOT GUNNA OUT RIZZ ME BRIANA!!!\"" << endl;
  cin >> reply;
  cout << "=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=" << endl;
  ...
  while (dateHP >= 0) {
    ...
    if(playerHP <= 0){
      ...
      cout << endl;
      cout << "1 - Smooth Compliment (" << Character::getMove1() << " dmg)" << endl; 
      cout << "2 - Handheld Mirror Check Up (Heals " << Character::getMove2() << " health)" << endl; 
      cout << "3 - Light Skin Stare (3 round charge up) (" << Character::getMove3() << " dmg)" << endl; 
...
void LightSkin::SecondDate(){
  ...
  if(winorlose == "win"){
    cout << endl << "  Tariq: \"...\"" << endl;
    cin >> reply;
    cout << endl << "  You: \"Sorry you couldn't handle my rizz.\"" << endl;
    cin >> reply;
    cout << endl << "*Tariq is too shocked to respond...*" << endl;
    cin >> reply;
    cout << endl << "  Tariq: \"...\"" << endl;
    cin >> reply;
    cout << endl << "  You: \"I know your embarrassed baby, but I'm just the rizz god.\"" << endl;
    cin >> reply;
    cout << endl << "  Tariq: \"I....how...\"" << endl;
    cin >> reply;
    cout << endl << "  You: \"Shhh baby...\"" << endl;
    cin >> reply;
    cout << endl << "*Tariq runs off in embarrassment*" << endl;
    cin >> reply;
    cout << endl << "  Tariq whilst running off: \"YOU'LL NEVER OUT RIZZ ME AGAIN!!!\"" << endl;
    cin >> reply;
    system("clear");
...
void LightSkin::ThirdDate(){
  ...
  cin >> reply;
  cout << endl << "  You: \"I'm doing good!\"" << endl;
  cin >> reply;
  ...
  cin >> reply;
  cout << endl << "  You: \"It looks like I am going to have to out rizz you...\"" << endl;
  cin >> reply;
  ...
  if(winorlose == "win"){
    cout << endl << "  Dan: \"I gave it a valiant effort!\"" << endl;
    cin >> reply;
    cout << endl << "  You: \"Yea but you can't best the rizz god.\"" << endl;
    cin >> reply;
    cout << endl << "  Dan: \"It appears that I can't...\"" << endl;
    cin >> reply;
    cout << endl << "  You: \"NOW SAY IM THE RIZZ GOD\"" << endl;
    cin >> reply;
    cout << endl << "  Dan: \"...no\"" << endl;
    cin >> reply;
    cout << endl << "  You: \"SAY IT\"" << endl;
    cin >> reply;
